...
pkgdatadir = $(datadir)/classa
pkgincludedir = $(includedir)/classa
pkglibdir = $(libdir)/classa
pkglibexecdir = $(libexecdir)/classa
...
am_classa_OBJECTS = main.$(OBJEXT) ClassA.$(OBJEXT) \
	HTTP_Server.$(OBJEXT)
classa_OBJECTS = $(am_classa_OBJECTS)
classa_LDADD = $(LDADD)
classa_LINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) $(classa_LDFLAGS) \
	$(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__depfiles_remade = ./$(DEPDIR)/ClassA.Po ./$(DEPDIR)/HTTP_Server.Po \
	./$(DEPDIR)/main.Po
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(classa_SOURCES)
DIST_SOURCES = $(classa_SOURCES)
...
ACLOCAL = ${SHELL} '/home/sanya/devOps/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/sanya/devOps/missing' autoconf
AUTOHEADER = ${SHELL} '/home/sanya/devOps/missing' autoheader
AUTOMAKE = ${SHELL} '/home/sanya/devOps/missing' automake-1.16
AWK = mawk
CPPFLAGS = 
CSCOPE = cscope
CTAGS = ctags
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/sanya/devOps/missing' makeinfo
...
abs_top_srcdir = /home/sanya/devOps
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/sanya/devOps/install-sh
...
classa$(EXEEXT): $(classa_OBJECTS) $(classa_DEPENDENCIES) $(EXTRA_classa_DEPENDENCIES) 
	@rm -f classa$(EXEEXT)
	$(AM_V_CXXLD)$(classa_LINK) $(classa_OBJECTS) $(classa_LDADD) $(LIBS)
...
include ./$(DEPDIR)/ClassA.Po # am--include-marker
